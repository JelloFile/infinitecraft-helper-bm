/*THIS FILE IS PURELY FOR EXPERIMENTAL PURPOSES. DO NOT USE, BECAUSE YOU RISK YOUR INFINITE CRAFT DATA GETTING DELETED. */
...
let sign = prompt("Would you like to export or import data? type i for import and e for export. for extra options, type m. leave blank if you dont wanna proceed. (created by JelloFile)");
...
if (sign.toLowerCase() === "m") {
let sign2 = prompt("EXTRA OPTIONS: Load something idk work on this")
};
